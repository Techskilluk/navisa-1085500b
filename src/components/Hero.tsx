...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] flex items-center justify-center px-4 pt-20 lg:pt-0 overflow-hidden"
         style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
          ...
          <p className="text-lg sm:text-xl text-gray-700 max-w-xl mx-auto lg:mx-0 animate-fade-in delay-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in delay-200">
            <Button 
              className="w-full sm:w-auto px-6 py-6 text-lg bg-black text-white hover:bg-black/90 flex items-center gap-2"
            ...
            <Link to="/enterprise" className="w-full sm:w-auto">
              <Button 
                variant="outline"
                className="w-full sm:w-auto px-6 py-6 text-lg border-black text-black hover:bg-black/10 flex items-center gap-2"
              >
                For Businesses
          ...
          <div className="grid grid-cols-3 gap-8 pt-8 animate-fade-in delay-300">
            <div className="text-center lg:text-left">
              <div className="text-2xl lg:text-3xl font-bold text-black">150+</div>
              <div className="text-sm lg:text-base text-gray-600">Success Stories</div>
            </div>
            <div className="text-center lg:text-left">
              <div className="text-2xl lg:text-3xl font-bold text-black">35+</div>
              <div className="text-sm lg:text-base text-gray-600">Countries</div>
            </div>
            <div className="text-center lg:text-left">
              <div className="text-2xl lg:text-3xl font-bold text-black">24/7</div>
        ...
        <div className="relative hidden lg:block">
          ...
          <div className="absolute -bottom-4 -right-4 w-72 h-72 bg-black/5 rounded-full blur-3xl"></div>
        </div>
      </div>
    </div>
  );
